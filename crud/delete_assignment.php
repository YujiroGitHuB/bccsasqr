...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assignment_id'])) {
    ...
    $checkQuery = mysqli_query($conn, "SELECT * FROM subject_instructors_tbl WHERE id = '$assignmentId'");
    ...
    $deleteQuery = mysqli_query($conn, "DELETE FROM subject_instructors_tbl WHERE id = '$assignmentId'");
