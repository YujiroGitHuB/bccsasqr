...
class HttpStudentRepository implements StudentRepository {
  ...
  Future<StudentRecord?> findByStudentNumber(StudentNumber number) async {
    ...
    return _recordFrom(student, warnings: data['warnings']);
  }
  ...
  /// every widget.
  ///
  /// [warnings] sit beside `student` in the response, not inside it, but they
  /// are about this student and travel with the record from here on.
  StudentRecord _recordFrom(Map<String, dynamic> student, {Object? warnings}) {
    try {
