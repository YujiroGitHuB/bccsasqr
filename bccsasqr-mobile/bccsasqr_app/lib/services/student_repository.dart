...
class InMemoryStudentRepository implements StudentRepository {
  ...
  static const List<Map<String, dynamic>> _rawRecords = [
    ...
    },
    {
      ...
      'course': 'BS Education',
      'section': 'BSED 1-A',
      // One record with nothing on file, so the photo warning can be seen
      // without a server. No action: there is no upload page to send a demo
      // student to.
      'warnings': [
        {
          'code': 'photo_missing',
          'message':
              'You need to upload your photo before you can record '
              'attendance. Open the Student Photo page, upload your picture, '
              'then try again.',
        },
      ],
    },
